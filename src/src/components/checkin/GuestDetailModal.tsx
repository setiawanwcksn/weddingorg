  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[60]">
        ...
        {/* Card */}
        <div className="absolute left-1/2 top-2 sm:top-4 -translate-x-1/2 w-[96%] sm:w-[60%] max-w-[340px] sm:max-w-[480px] md:max-w-[420px] rounded-2xl border border-border bg-accent shadow-lg overflow-hidden max-h-[92vh] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="p-3 sm:p-3.5 md:p-4 relative">
              ...
              <button
                aria-label="Close"
                onClick={onClose}
                className="absolute top-5 right-5 p-1.5 rounded-full bg-black/20 text-white hover:bg-black/40 transition-colors z-10"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
          ...
          <div className="px-3 sm:px-4 md:px-5 py-3 sm:py-4 border-t border-border flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-accent">
            <button
              type="button"
              onClick={handlePrint}
